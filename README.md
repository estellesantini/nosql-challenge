# NoSQL Challenge
Estelle Santini | UC Berkeley Data Analytics | 05/16/2023 
## Background
...
1. Within your notebook, import the libraries you need: PyMongo and Pretty Print (pprint).

2. Create an instance of the Mongo Client.

3. Confirm that you created the database and loaded the data properly:
...
An exciting new halal restaurant just opened in Greenwich, but hasn't been rated yet. The magazine has asked you to include it in your analysis. I added given information on this restaurant into the database.
